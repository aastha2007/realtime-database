...
/*
.ref() is used to refer to the location of the database value.
.on() creates a listener which keeps listening to the changes in the database.
everytime a change in the database values of position(reference)happence,the readPosition function is called.
